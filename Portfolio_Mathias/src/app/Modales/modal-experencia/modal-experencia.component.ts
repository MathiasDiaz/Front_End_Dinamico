...
@Component({
  selector: 'app-modal-experencia',
  templateUrl: './modal-experencia.component.html',
  styleUrls: ['./modal-experencia.component.css']
})
export class ModalExperenciaComponent implements OnInit {
